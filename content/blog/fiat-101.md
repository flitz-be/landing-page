...
Allmost all payment worldwide are processed in some way by 2(!) companies: VISA and Mastercard. The infrastructure __requires__ large-scale surveillance to function, so there must be a better alternative.
